...
you are using, and simply stand infront of the pet game sigil in Wizard101. The program will press X, randomly choose 
one of the five levels, and start the game. Then, it will play the game automatically, proceed without feeding any
snacks (future plans include snack compatability), and start another game automatically. This will repeat until the 
1000s runtime is complete or you terminate the program early. 
...
pixels on the screen. I will list the lines of code that include specific references to my computer's resolution here:
    tools.py Line 145 - Screen coordinates for arrow screenshow
    tools.py Line 8 - Loading screenshots that were originally taken on my computer's native resolution
