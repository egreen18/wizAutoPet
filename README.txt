...
one of the five levels, and start the game. Then, it will play the game automatically, feed a snack if the snack 
parameter is set to one, and start another game automatically. This will repeat until the 1000s runtime is complete, 
you run out of energy, or you terminate the program early. 
